...
See the common description of ini-file in python module [confiparser](https://docs.python.org/3/library/configparser.html), class configparser.ExtendedInterpolation.
