if __name__ == "__main__":
	...
	try: contact_count = config['simulation']['contact_count']
		...
		except: raise UndefinedValues('The value "contact_count" in section [global] or [simulation] is not defined!')
	...
	try: contact_count = config['wild_type']['contact_count']
		...
		try: contact_count = config['simulation']['contact_count']
			...
			except: raise UndefinedValues('The value "contact_count" in sections [global], or [simulation], or [wt] is not defined!')
