					...
					for j in range(i,chr_num+1):
						...
						if path_to_juicertools:
							if path_to_java_dir: 
								...
								if control != 0:
									gf.printlog('\n!!!Juicertools dump error: Java or juicertools, or hic-file is absent on defined path!!!', log_file)
									raise OSError('\n!!!Juicertools dump error: Java or juicertools, or hic-file is absent on defined path!!!')
							else: 
